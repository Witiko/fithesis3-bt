...
\thesislong{thanks}{
  Na tomto místě bych chtěl poděkovat doc. RNDr. Petru Sojkovi, Ph.D.
  za odborné vedení při zpracování této bakalářské práce, doc. Ing.
  Michalovi Brandejsovi, CSc. za trpělivost a zprostředkování
  metadat závěrečných prací.

  Dále bych chtěl poděkovat svým rodičům za podporu během celého
  studia.}
