...
\thesislong{thanks}{I wish to express my sicere
  thanks to \thesis{advisor} for sharing expertise, valuable
  guidance and encouragement, doc.  Ing.  Michal Brandejs, CSc. for
  having provided me with statistical data, which proved invaluable
  for the initial research, and one and all who, directly or
  indirectly, have lent their hand in this venture. I also thank my
  parents for their unceasing encouragement, support and
  attention.}
...
%  \end{table}
  ...
  for the archival of physical prints of theses.\pending{Decrease
  the horizontal margins of \textsf{fithesis3} loaded with the
  \texttt{twocolumn} option to achieve roughly 65 characters per
  line in each column with either the 11\,pt or the 10\,pt font
  size to make multicolumn typesetting viable. This would allow for
  more economical use of paper. \url{http://tex.stackexchange.com/%
  questions/24561/setting-the-column-gap-in-a-twocolumn-or-multico%
  l-document}}
  \index{CTUStyle|)}
  \index{CUStyle|)}
