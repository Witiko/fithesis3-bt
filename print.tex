\documentclass[digital,table,color]{fithesis3/fithesis3}
...
\thesissetup{
  ...
  basePath    = ./fithesis3,
  assignment  = {./misc/assignment, ./misc/declaration}}
...
\gls{docclass}, but bear relevance to its development.
  ...
  Mgr.\ Tomáš Fábry as the implementation part of his master's
...
will also be considered.
  ...
  Rybička's \hyperref[sec:dipp.sty]{\texttt{dipp.sty}},
  \textsf{diploma} uses the base \textsf{article} \gls{docclass},
  modifies its geometry and adds thesis sectioning commands and
  additional macros for the users' convenience \cite{diploma}. The
  output documents are one-sided by default and the font size of
  11\,pt is too small for the \gls{textwidth} of \begin{equation}
    \begin{split}
...
\gls{docclass} along with its design and implementation.
  ...
  \begin{figure}
    ...
    \parbox{0.5\textwidth}{\dirtree{%
      .1 locale/.
        .2 fithesis-\textit{locale}.def.
        .2 \textit{university}/.
          .3 fithesis-\textit{locale}.def.
          .3 \textit{faculty}/.
            .4 fithesis-\textit{locale}.def.
    }}
  ...
  \begin{figure}
    \centering
    \parbox{0.6\textwidth}{\dirtree{%
      .1 logo/.
        .2 \textit{university}/.
          .3 fithesis-base.eps.
          .3 fithesis-base.pdf.
          .3 fithesis-base-color.eps.
          .3 fithesis-base-color.pdf.
          .3 fithesis-\textit{faculty}.eps.
          .3 fithesis-\textit{faculty}.pdf.
          .3 fithesis-\textit{faculty}-color.eps.
          .3 fithesis-\textit{faculty}-color.pdf.
    }}
  ...
  layout definitions in the \texttt{fithesis-base.sty} style file
  and the \texttt{fithesis-10}, \texttt{11} and \texttt{12.clo}
...
\includepdf[pages=-]{./misc/fi}

\fakechapter{A \textsf{fithesis3} user guide for the Faculty of
  Science}
\includepdf[pages=-]{./misc/sci}

\fakechapter{A \textsf{fithesis3} user guide for the Faculty of
  Economics and Administration}
\includepdf[pages=-]{./misc/econ}

\fakechapter{A \textsf{fithesis3} user guide for the Faculty of
  Social Studies}
\includepdf[pages=-]{./misc/fss}

\fakechapter{A \textsf{fithesis3} user guide for the Faculty of Law}
\includepdf[pages=-]{./misc/law}

\fakechapter{A \textsf{fithesis3} user guide for the Faculty of
  Medicine}
\includepdf[pages=-]{./misc/med}

\fakechapter{A \textsf{fithesis3} user guide for the Faculty of
  Education}
\includepdf[pages=-]{./misc/ped}

\fakechapter{A \textsf{fithesis3} user guide for the Faculty of
  Arts}
\includepdf[pages=-]{./misc/phil}

\fakechapter{A \textsf{fithesis3} user guide for the Faculty of
  Sports Studies}\label{sec:fspsguide}
\includepdf[pages=-]{./misc/fsps}

\fakechapter{The technical documentation of
  \textsf{fithesis3}}\label{sec:techdoc}
\includepdf[pages=-]{./misc/fithesis}
\end{appendices}
