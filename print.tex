\documentclass[12pt,twoside,color,table]%
  {fithesis3/fithesis/fithesis3} % 0_0
...
\gls{docclass} along with its design and implementation.
  ...
  \texttt{fithesis-} filename prefix serves to prevent naming
  ...
  enabled. The \texttt{fithesis-} filename prefix serves to prevent
  naming collisions. Since the \gls{tds} is flat, omitting the
  prefix would run the risk of clashing with similarly named files.
