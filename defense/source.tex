...
\thesissetup{
  ...
  locale = myLocale, style = myStyle,
  autoLayout = false}
\begin{document}
  \makeatletter
    \thesis@blocks@cover
    \thesis@blocks@frontMatter
      \thesis@blocks@titlePage  \thesis@blocks@declaration
      \thesis@blocks@thanks     \thesis@blocks@abstract
      \thesis@blocks@keywords   \thesis@blocks@tables
