\documentclass[color,table,nocover,twoside,lot,lof]{../../fithesis3}
...
\makeatother
\begin{document}
  \makeatletter\thesis@blocks@titlePage\thesis@blocks@mainMatter\makeatother\setcounter{page}{159}
