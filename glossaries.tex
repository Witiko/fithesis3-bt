...
\newglossaryentry{implemented}{
  name = \textcolor{orange}{IMPLEMENTED},
  sort = IMPLEMENTED,
...
\newglossaryentry{todo}{
  ...
  sort = TODO,
  description = {A feature or a part of the text, whose implementation is pending}
}
