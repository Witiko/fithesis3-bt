...
classes}][shortplural={document classes},longplural={\gls{latex}
document classes}]{docclass}{document class}{\gls{latex} document
class}{A set of \gls{latex} macros, which define the layout of the
resulting document.}
...
\newglossaryentry{cslatex}{
  ...
  sort = CSLaTeX,
  description = {A software package, which simplifies the task of
  typesetting Czech and Slovak documents in \LaTeX{}. \CSLaTeX{}
  has been obsoleted in favour of the babel package
  \cite{cslatexvsbabel}}
}
